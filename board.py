...
class cell():
    """ Cell object to represent one of the 81 squares in a
        sudoku puzzle. Each cell has a set of possible answers, correct answer, position, and the fact that it solved."""
    ...
    def solvedMethod(self):
        """ Checks if a cell has been solved """
        return self.solved

    def returnPossible(self):
        """ Returns all remaining possibilities """
        return self.possibleAnswers
    
    def checkPosition(self):
        """ Returns position of cell in row, column, box format """
    ...
    def returnSolved(self):
        """ Returns whether or not a cell has been solved, along with its value """
        if self.solved == True:
    ...
    def setAnswer(self, num):
        """ Sets solved variable to true; makes sure only valid numbers are input """
    ...
    def reset(self):
        """ Resets cell and respective attributes """ 
        self.possibleAnswers = [1,2,3,4,5,6,7,8,9]
        self.answer = None
        self.solved = False
